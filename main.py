...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @IAN CPM ')) 
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '========[ IAN TOOL DETAILS ]========'))
